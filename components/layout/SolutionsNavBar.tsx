import styles from "@/styles/layout/solutionsnavbar.module.css";
...
export default function SolutionsNavBar({ onSelect }) {
  const locale = useLocale();

  const t = useTranslations('Menu.solutions');

  const project1 = lhref("/solutions", locale) + "?section=project1";
  const project2 = lhref("/solutions", locale) + "?section=project2";
  const project3 = lhref("/solutions", locale) + "?section=project3";
